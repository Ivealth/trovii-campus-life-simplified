    ...
    <footer className="bg-white">
      ...
      <div className="border-t border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-[15px] sm:text-[17px] text-stone-600 mb-6 sm:mb-8">
              Join 1,200+ students who are saving time and earning money with Trovii.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-stone-900 hover:bg-stone-800 text-white font-medium text-[13px] sm:text-[14px] px-6 sm:px-7 h-11 sm:h-12 rounded-lg"
              >
                Get started free
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto border-stone-300 text-stone-700 hover:bg-stone-50 font-medium text-[13px] sm:text-[14px] px-6 sm:px-7 h-11 sm:h-12 rounded-lg"
              >
                Contact sales
              </Button>
            </div>
      ...
      <div className="border-t border-stone-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 sm:gap-8 mb-10 sm:mb-12">
            ...
            <div className="sm:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-[16px] sm:text-[17px] font-semibold text-stone-900">Trovii</span>
              </div>
              <p className="text-[13px] sm:text-[14px] text-stone-600 mb-5 sm:mb-6 max-w-xs leading-relaxed">
            ...
            {/* Product */}
            <div>
              <h3 className="font-semibold text-[13px] sm:text-[14px] text-stone-900 mb-3 sm:mb-4">Product</h3>
              <ul className="space-y-2.5 sm:space-y-3 text-[13px] sm:text-[14px]">
            ...
            {/* Company */}
            <div>
              <h3 className="font-semibold text-[13px] sm:text-[14px] text-stone-900 mb-3 sm:mb-4">Company</h3>
              <ul className="space-y-2.5 sm:space-y-3 text-[13px] sm:text-[14px]">
            ...
            {/* Legal */}
            <div>
              <h3 className="font-semibold text-[13px] sm:text-[14px] text-stone-900 mb-3 sm:mb-4">Legal</h3>
              <ul className="space-y-2.5 sm:space-y-3 text-[13px] sm:text-[14px]">
          ...
          {/* Bottom Bar */}
          <div className="pt-6 sm:pt-8 border-t border-stone-200 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            <p className="text-[13px] sm:text-[14px] text-stone-500 text-center sm:text-left">
              © {new Date().getFullYear()} Trovii by Ivealth LTD. All rights reserved.
            </p>
            <p className="text-[13px] sm:text-[14px] text-stone-500">
              Made for students
            </p>
          </div>
        </div>
